...
class SearchBySongPage extends React.Component {
  ...
  updateSearchResults() {
    getSongSearch(
      ...
      this.state.danceabilityLowQuery,
      this.state.danceabilityHighQuery,
      this.state.energyLowQuery,
      this.state.energyHighQuery,
      this.state.livenessLowQuery,
      this.state.livenessHighQuery,
      this.state.tempoLowQuery,
      this.state.tempoHighQuery,
      this.state.valenceLowQuery,
      this.state.valenceHighQuery,
                ...
                <Form>
                  ...
                  <FormGroup style={{ width: "90%", margin: "auto" }}>
                    ...
                    <Slider
                      ...
                      step={0.01}
                      defaultValue={[0, 1]}
                      onChange={this.handleLivenessChange}
                    />
                    <label> Tempo</label>
                    <Slider
                      range
                      ...
                      domains={[
                        {
                          name: "Valence",
                          domain: [0, 1],
                          getValue: (d) => (d.valence ? d.valence : 0),
                        },
                        {
                          name: "Danceability",
                          domain: [0, 1],
